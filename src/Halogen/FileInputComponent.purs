-- borrowed from https://github.com/newlandsvalley/purescript-halogen-components
-- (Couldn't just depend on it cause some other modules were not ready for 0.12
